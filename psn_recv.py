...
class PSNDecoder:
    ...
    def decode_data_packet(self, data):
        ...
        try:
            ...
            logging.error(f"Error unpacking PSN_DATA_PACKET_HEADER: {e}")
            return
        ...
        while offset < len(data):
            try:
                ...
                if chunk_id == PSN_DATA_TRACKER_LIST:
                    ...
                    while offset < end_offset:
                        if offset + struct.calcsize('<HH') > len(data):
                            logging.warning(f"Not enough buffer left to unpack tracker ID and length at offset {offset}")
                            break
                ...
                logging.error(f"Error unpacking PSN_DATA chunk: {e}")
                break
